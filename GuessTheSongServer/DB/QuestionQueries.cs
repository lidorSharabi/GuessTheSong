...
namespace GuessTheSongServer.DB
{
    ...
    {
        public static string artist_genre_years_Query = @"SELECT lyrics.song, lyrics.artist, lyrics.lyrics FROM team12.lyrics
...
LIMIT 20";
        ...
        public static string artist_genre_widerYears_Query = @"SELECT lyrics.song, lyrics.artist, lyrics.lyrics FROM team12.lyrics
WHERE lyrics.artist = '{0}'
AND lyrics.genre = '{1}'
